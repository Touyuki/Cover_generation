...
class example_dataset(Dataset):
    ...
    def __init__(self, title_str, data_dir = cfg.example_data_dir, transform = None):
    ...
    def __getitem__(self, idx):
        ...
        i_t = io.imread(os.path.join("64_title_image/ori/", self.tit + '.png'))
        # random_index=random.randint(1,378)
        i_s = io.imread(os.path.join("64_title_image/t/",self.tit + '.png' ))
