...
parser.add_argument('--num_iterations', default=100000, type=int)##2
...
#                     default=os.path.join(COCO_DIR, 'images/tt/val20173'))
# parser.add_argument('--coco_train_image_dir',
#                     default=os.path.join(COCO_DIR, 'images/figure1'))
parser.add_argument('--coco_train_image_dir_title',
                    default=os.path.join(COCO_DIR, 'images/0217_coco_title'))##
# parser.add_argument('--coco_val_image_dir',
#                     default=os.path.join(COCO_DIR, 'images/figure1'))
parser.add_argument('--coco_val_image_dir_title',
                    default=os.path.join(COCO_DIR, 'images/0217_coco_title'))##
# parser.add_argument('--coco_train_instances_json',
#                     default=os.path.join(COCO_DIR, 'annotations/instances_val2017_tit9.json'))
# parser.add_argument('--coco_train_instances_json',
#                     default=os.path.join(COCO_DIR, 'annotations/simple.json'))
parser.add_argument('--coco_train_instances_json_title',
                    default=os.path.join(COCO_DIR, 'annotations/instances_val2017.json'))##
# parser.add_argument('--coco_train_stuff_json',
#                     default=os.path.join(COCO_DIR, 'annotations/simple.json'))
parser.add_argument('--coco_train_stuff_json_title',
                    default=os.path.join(COCO_DIR, 'annotations/title_mask_coco3.json'))##
# parser.add_argument('--coco_val_instances_json',
#                     default=os.path.join(COCO_DIR, 'annotations/simple.json'))
parser.add_argument('--coco_val_instances_json_title',
                    default=os.path.join(COCO_DIR, 'annotations/instances_val2017.json'))##
# parser.add_argument('--coco_val_stuff_json',
#                     default=os.path.join(COCO_DIR, 'annotations/simple.json'))
parser.add_argument('--coco_val_stuff_json_title',
                    default=os.path.join(COCO_DIR, 'annotations/title_mask_coco3.json'))##
parser.add_argument('--coco_panoptic_train', default=os.path.join(COCO_DIR, 'annotations/total2.json'))
parser.add_argument('--coco_panoptic_val', default=os.path.join(COCO_DIR, 'annotations/total2.json'))
...
parser.add_argument('--min_objects_per_image_title', default=1, type=int)##
...
parser.add_argument('--d_cover_weight', default=1.0, type=float)
parser.add_argument('--d_img_features_weight', default=10.0, type=float)
parser.add_argument('--d_cover_features_weight', default=10.0, type=float)
...
parser.add_argument('--checkpoint_every', default=4000, type=int)##
# parser.add_argument('--checkpoint_every', default=2000, type=int)
parser.add_argument('--output_dir', default=log_dir) ##
# parser.add_argument('--output_dir', default="tmp_dir")
