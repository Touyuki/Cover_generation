...
parser.add_argument('--image_size', default=(128, 128), type=int_tuple) ##400,256
...
# parser.add_argument('--coco_image_dir', default=os.path.join(COCO_DIR, 'images/tt/val20173'))
# parser.add_argument('--instances_json', default=os.path.join(COCO_DIR, 'annotations/instances_val2017_tit9.json'))
# parser.add_argument('--stuff_json', default=os.path.join(COCO_DIR, 'annotations/stuff_val2017_tit9.json'))
parser.add_argument('--coco_image_dir', default=os.path.join(COCO_DIR, 'images/0217_coco_title'))
parser.add_argument('--instances_json', default=os.path.join(COCO_DIR, 'annotations/instances_val2017.json'))
parser.add_argument('--stuff_json', default=os.path.join(COCO_DIR, 'annotations/title_mask_coco3.json'))
...
def build_coco_dset(args, checkpoint):
    ...
    dset_kwargs = {
        ...
        # 'min_objects_per_image': checkpoint_args['min_objects_per_image_title'],
...
def cluster(features, num_objs, n_clusters, save_path): ### feature 172 100
    name = 'features'
    centers = {}
