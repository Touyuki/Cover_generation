...
class UnetGeneratorCSA(nn.Module):
    def __init__(self, input_nc, output_nc,  num_downs, opt, mask_global, csa_model,cosis_list ,cosis_list2,ngf=64,
        ...
        unet_block = UnetSkipConnectionBlock_3(ngf * 4, ngf * 8, input_nc=None,submodule=unet_block, norm_layer=norm_layer)##
        unet_block = UnetSkipConnectionBlock_3(ngf * 2, ngf * 4, input_nc=None,submodule=unet_block, norm_layer=norm_layer)
