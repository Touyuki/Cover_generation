...
def uncrop_bbox(feats, bbox, H, W=None, fill_value=0):
    ...
    x0, y0 = bbox[:, 0], bbox[:, 1]
    x1, y1 = bbox[:, 2] + bbox[:, 0], bbox[:, 3] + bbox[:, 1]
    ww = x1 - x0
    hh = y1 - y0
...
if __name__ == '__main__':
    ...
    # cat = imresize(imread('cat.png'), (256, 256), anti_aliasing=True)
    # dog = imresize(imread('dog.png'), (256, 256), anti_aliasing=True)
    cat = imresize(imread('cat.png'), (256, 256))
